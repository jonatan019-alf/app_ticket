...
//   const [mostrarPassCrear, setMostrarPassCrear] = useState(false);
//   const [mostrarPassEditar, setMostrarPassEditar] = useState(false);
//   const [verPassTabla, setVerPassTabla] = useState({}); // Controla la visibilidad por ID en la lista
...
//       <form onSubmit={handleSubmitCrear} style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', marginBottom: '2rem' }}>
...
//             onChange={handleChangeCrear}
//             required
//             style={{ padding: '0.5rem', width: '100%', paddingRight: '2.5rem' }}
//           />
//           <button
//             type="button"
//             onClick={() => setMostrarPassCrear(!mostrarPassCrear)}
...
//           ¿Es Administrador?
//         </label>
//         <button type="submit" style={{ padding: '0.6rem', backgroundColor: '#0d6efd', color: '#fff', border: 'none', cursor: 'pointer', borderRadius: '4px' }}>
//           Guardar Técnico
//         </button>
//       </form>
...
//       {/* Lista de Técnicos con opción de Modificación */}
...
//                         value={editData.password}
//                         onChange={handleChangeEditar}
//                         style={{ width: '100%', padding: '0.3rem', paddingRight: '2rem' }}
//                       />
//                       <button
//                         type="button"
//                         onClick={() => setMostrarPassEditar(!mostrarPassEditar)}
...
//     nombre: '',
//     email: '',
//     password: '', // Campo opcional para cambio de clave
//     activo: true,
//     es_admin: false
//   });
...
//             <th style={{ padding: '8px', border: '1px solid #444' }}>Nombre</th>
//             <th style={{ padding: '8px', border: '1px solid #444' }}>Email</th>
//             <th style={{ padding: '8px', border: '1px solid #444' }}>Nueva Clave</th>
//             <th style={{ padding: '8px', border: '1px solid #444' }}>Estado</th>
//             <th style={{ padding: '8px', border: '1px solid #444' }}>Rol</th>
//             <th style={{ padding: '8px', border: '1px solid #444' }}>Acciones</th>
//           </tr>
...
//                   <td style={{ padding: '8px' }}>{tec.nombre}</td>
//                   <td style={{ padding: '8px' }}>{tec.email}</td>
//                   <td style={{ padding: '8px', color: '#888', fontSize: '0.85rem' }}>••••••••</td>
//                   <td style={{ padding: '8px' }}>
//                     <span style={{ color: tec.activo ? '#198754' : '#dc3545', fontWeight: 'bold' }}>
//                       {tec.activo ? 'Activo' : 'Inactivo'}
//                     </span>
