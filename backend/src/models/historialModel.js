...
// const Historial = {
//   // Obtener TODO el historial global (orden descendente)
//   getAll: async () => {
//     const query = `
//       SELECT 
//         h.*,
...
//   // Obtener todo el historial de un ticket específico
//   getByTicketId: async (ticket_id) => {
//     const query = `
//       SELECT 
//         h.*,
...
//     const query = `
//       INSERT INTO historial_tickets (
//         ticket_id, tecnico_id, estado_anterior, estado_nuevo, nota_tecnica
//       )
//       VALUES ($1, $2, $3, $4, $5)
//       RETURNING *;
//     `;
...
//     const values = [ticket_id, tecnico_id, estado_anterior, estado_nuevo, nota_tecnica];
//     // Acepta ejecucion dentro de transaccion o consulta directa
//     const { rows } = await client.query(query, values);
//     return rows[0];
//   }
// };
