...
//     // 2. Disparar e-mail de confirmación si existe el servicio
//     if (typeof enviarConfirmacionTicket === 'function') {
//       enviarConfirmacionTicket(nuevoTicket || datosNuevoTicket);
//     }
...
//     // 4. DISPARAR EMAIL DE ACTUALIZACIÓN AL CLIENTE
//     if (typeof enviarActualizacionTicket === 'function') {
//       enviarActualizacionTicket(respuestaFinal);
//     }
...
// const Ticket = require('../models/ticketModel');
// const Historial = require('../models/historialModel');
// const { enviarConfirmacionTicket } = require('../services/emailService');
...
//           const historial = await Historial.getByTicketId(ticket.id);
//           // Si hay historial, tomamos la nota más reciente que no sea nula
//           const ultimaNota = historial.reverse().find(h => h.nota_tecnica && h.nota_tecnica.trim() !== '');
//           ticket.nota_tecnica = ultimaNota ? ultimaNota.nota_tecnica : '';
//         }
//         return ticket;
//       })
...
//     // 2. Disparar e-mail de confirmación si existe el servicio
//     if (typeof enviarConfirmacionTicket === 'function') {
//       enviarConfirmacionTicket(nuevoTicket);
//     }
...
//     // 3. Formatear la respuesta con la nota técnica cargada
//     const respuestaFinal = {
//       ...(ticketActualizado || ticketExistente),
//       ...dataActualizada,
//       id: parseInt(id, 10),
//       nota_tecnica: nota_tecnica || dataActualizada.nota_tecnica || ''
//     };
...
//       area_id: req.body.area_id !== undefined ? parseInt(req.body.area_id, 10) : ticketExistente.area_id,
//       categoria_id: req.body.categoria_id !== undefined ? parseInt(req.body.categoria_id, 10) : ticketExistente.categoria_id,
//       asignado_a_tecnico_id: req.body.asignado_a_tecnico_id !== undefined 
//         ? (req.body.asignado_a_tecnico_id ? parseInt(req.body.asignado_a_tecnico_id, 10) : null)
//         : ticketExistente.asignado_a_tecnico_id,
//       usuario_reporta: req.body.usuario_reporta || ticketExistente.usuario_reporta,
//       email_contacto: req.body.email_contacto || ticketExistente.email_contacto,
//       titulo: req.body.titulo || ticketExistente.titulo,
//       descripcion_problema: req.body.descripcion_problema || ticketExistente.descripcion_problema,
//       prioridad: req.body.prioridad ? req.body.prioridad.toUpperCase() : ticketExistente.prioridad,
//       estado_actual: req.body.estado_actual ? req.body.estado_actual.toUpperCase() : ticketExistente.estado_actual
//     };
...
// // Actualizar ticket (Acepta actualización de estado y guarda el historial implícito)
// const updateTicket = async (req, res) => {
//   const { id } = req.params;
//   const { nota_tecnica } = req.body;
...
//     // Fusionamos los datos actuales con los nuevos datos recibidos
//     const dataActualizada = {
//       area_id: req.body.area_id !== undefined ? parseInt(req.body.area_id, 10) : ticketExistente.area_id,
//       categoria_id: req.body.categoria_id !== undefined ? parseInt(req.body.categoria_id, 10) : ticketExistente.categoria_id,
//       asignado_a_tecnico_id: req.body.asignado_a_tecnico_id !== undefined 
...
// // Crear ticket
// const createTicket = async (req, res) => {
//   const { codigo_ticket, area_id, categoria_id, usuario_reporta, titulo, descripcion_problema } = req.body;
...
//     // Error de violación de CHECK constraint (estado o prioridad no válidos)
//     if (error.code === '23514') {
//       return res.status(400).json({ error: 'Valor no permitido en el campo prioridad o estado_actual.' });
//     }
...
//     // Fusionamos los datos actuales con los nuevos datos recibidos
//     const dataActualizada = {
//       area_id: req.body.area_id || ticketExistente.area_id,
//       categoria_id: req.body.categoria_id || ticketExistente.categoria_id,
//       asignado_a_tecnico_id: req.body.asignado_a_tecnico_id !== undefined ? req.body.asignado_a_tecnico_id : ticketExistente.asignado_a_tecnico_id,
//       usuario_reporta: req.body.usuario_reporta || ticketExistente.usuario_reporta,
//       titulo: req.body.titulo || ticketExistente.titulo,
//       descripcion_problema: req.body.descripcion_problema || ticketExistente.descripcion_problema,
//       prioridad: req.body.prioridad || ticketExistente.prioridad,
//       estado_actual: req.body.estado_actual || ticketExistente.estado_actual
//     };

//     const ticketActualizado = await Ticket.update(id, dataActualizada);
//     res.status(200).json({
//       mensaje: 'Ticket actualizado correctamente',
//       ticket: ticketActualizado
//     });
