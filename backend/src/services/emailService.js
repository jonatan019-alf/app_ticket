...
//       <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
//         <h2 style="color: #2b2b2b;">¡Hola, ${usuario_reporta}!</h2>
//         <p style="color: #555;">Se han guardado cambios y novedades en tu ticket de soporte.</p>
//         <hr style="border: none; border-top: 1px solid #eee;" />
        
//         <h3 style="color: #333;">Detalles del Ticket Actualizado</h3>
//         <ul style="line-height: 1.8; color: #444;">
//           <li><strong>Código de Seguimiento:</strong> <span style="background-color: #f0f0f0; padding: 2px 6px; border-radius: 4px;">#${codigo_ticket}</span></li>
//           <li><strong>Asunto:</strong> ${titulo}</li>
//           <li><strong>Estado Actual:</strong> <strong style="color: #2563eb;">${estado_actual}</strong></li>
//           <li><strong>Prioridad:</strong> ${prioridad}</li>
//           <li><strong>Inconveniente:</strong> ${descripcion_problema}</li>
//         </ul>

//         ${
//           nota_tecnica 
//             ? `<div style="background-color: #f4f6f8; padding: 12px 15px; border-left: 4px solid #2563eb; margin-top: 15px; border-radius: 4px;">
//                  <strong style="color: #1e3a8a;">Solución / Observaciones Técnicas:</strong>
//                  <p style="margin-top: 5px; color: #333; white-space: pre-line;">${nota_tecnica}</p>
//                </div>`
//             : ''
//         }
...
// // 3. NUEVA: Función para enviar la actualización de ticket
// const enviarActualizacionTicket = async (datosTicket) => {
//   const { 
//     codigo_ticket, 
//     email_contacto, 
